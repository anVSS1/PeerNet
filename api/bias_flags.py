'''
PeerNet++ Bias Flags API
========================
REST API endpoints for reviewer bias flag management.

Endpoints:
- GET /bias-flags/<paper_id>: Get all bias flags for a paper
- POST /bias-flags/<paper_id>: Add manual bias flag
- DELETE /bias-flags/<flag_id>: Remove false positive flag

Bias flags are automatically generated by BiasDetectionAgent
but can also be manually added by reviewers.
'''
